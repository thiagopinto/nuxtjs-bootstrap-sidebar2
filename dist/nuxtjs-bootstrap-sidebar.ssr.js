...
var script = {
  ...
  beforeMount: function beforeMount() {
    ...
    this.show = this.window.addEventListener("resize", this.onResize);
...
var __vue_render__ = function __vue_render__() {
  ...
  return _c('div', {
  ...
  }, [_vm._ssrNode("<nav id=\"sidebar\" data-color=\"white\" data-active-color=\"danger\"" + _vm._ssrClass(null, "nuxtjs-bootstrap-sidebar   " + [_vm.show ? 'visible' : 'hidden'] + " " + _vm.theme + " " + _vm.align) + ">", "</nav>", [_vm._ssrNode("<div class=\"sidebar-header logo\">", "</div>", [_vm._ssrNode("<div class=\"logo-mini\">", "</div>", [_vm._t("logo")], 2), _vm._ssrNode(" "), _vm._ssrNode("<span" + _vm._ssrClass("sidebar-button", _vm.theme) + ">", "</span>", [_c('font-awesome-icon', {
    attrs: {
    ...
    return [link.href !== undefined ? [link.external ? [_c('b-list-group-item', {
      key: index,
      staticClass: "sidebar-menu-item mt-2 mb-2 pt-1 pb-1",
      class: "" + _vm.align,
      attrs: {
        "title": link.name,
        "href": link.href
      ...
      key: index,
      staticClass: "sidebar-menu-item sidebar-dropdown mt-2 mb-2 pt-1 pb-1",
      class: "" + _vm.align,
      staticStyle: {
      ...
      return _c('b-list-group-item', {
        key: idChild,
        staticClass: "sidebar-menu-item child-level-1 mt-2 mb-2 pt-1 pb-1",
        class: "" + _vm.align,
        attrs: {
          "title": child.name,
          "to": child.href
  ...
  })], 2)], 1), _vm._ssrNode(" "), _vm._t("footer")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div" + _vm._ssrClass(null, "main-panel " + [_vm.show ? 'visible' : 'hidden'] + " " + _vm.theme + " " + _vm.align) + ">", "</div>", [_c('b-nav', {
    ...
    staticClass: "sidebar-button-menu",
...
var __vue_module_identifier__ = "data-v-fd5fecd8";
/* functional template */
